        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
                ...
                <div className="Registration">
                    <span className='Text Authorization' id='Text_Authorization'>Данные для регистрации</span>
                </div>

                <span className='Text EmailInput' id='Text_Authorization'>Электронная почта</span>
                <input
                    {...register("Email", {
                ...
                <span className='Text UserData NameInput' id='Text_Authorization'>Имя</span>
                ...
                <span className='Text UserData' id='Text_Authorization'>Пароль</span>
            ...
            <div className='BottomFrame' onSubmit={handleSubmit(onSubmit)}>
                <h3 className='UsersData'>Полученные данные:</h3>
                {details.length > 0 ? (
                    <ul>
                        {details.map((detail, index) => (
                            <li className='UsersData' key={index}>{JSON.stringify(detail)}</li>
                        ))}
                    </ul>
                ) : (
                    <p className='UsersData'>Нет данных для отображения.</p>
                )}
            </div>
        </form>
    );
